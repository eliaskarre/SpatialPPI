...
Deliverables include a VR “project” (DataDiVR-compatible file/folder structure), a fully reproducible Python pipeline (PEP 8 notebooks/scripts; Python ≥ 3.9.1), a documented git repository (template and example notebooks provided), and a final report (Introduction, Materials/Methods, Results, Discussion). MencheLab members will support data interpretation and domain questions throughout the semester. 
